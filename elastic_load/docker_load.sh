...
pid=$!
# curl -XDELETE "http://elasticsearch:9200/games";


echo "Done starting elastic"

# nc -z -v elasticsearch
# curl http://0.0.0.0:9200/

# curl -XPUT "elasticsearch:9200/games" -H 'Content-Type: application/json' -d'
# {
#   "settings": {
#     "analysis": {
#       "filter": 
